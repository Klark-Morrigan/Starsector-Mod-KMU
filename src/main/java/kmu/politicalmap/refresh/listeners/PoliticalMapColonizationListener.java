 ...
 * ({@link PoliticalMapRefresh#markSystemPoliticsStale}), re-deriving only the
 ...
 */
public class PoliticalMapColonizationListener implements PlayerColonizationListener {
