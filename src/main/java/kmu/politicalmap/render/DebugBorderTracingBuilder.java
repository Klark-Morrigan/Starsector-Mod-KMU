...
final class DebugBorderTracingBuilder {
    ...
    static PoliticalMapDebugDrawables buildDebugDrawables(PoliticalMapGeometryCache geometryCache,
        ...
        var decivilisedSystemIds = DecivilisedPresence.findRevealedDecivilisedSystemIds(sector);
        ...
        addFactionlessOutlines(geometryCache, ownerBySystemId, decivilisedSystemIds,
    ...
    private static void addFactionlessOutlines(PoliticalMapGeometryCache geometryCache,
            Map<String, DominantOwner> ownerBySystemId, Set<String> decivilisedSystemIds,
        ...
        for (var entry : geometryCache.getCellEdgesBySystemId().entrySet()) {
            if (ownerBySystemId.containsKey(entry.getKey())) {
                continue;
            }
            ...
            var shaped = CellShaper.shapeCell(entry.getValue(), null, ownerBySystemId,
