...
final class BorderSmoothing {
    ...
    static List<List<double[]>> sandBorderSpikes(List<List<double[]>> loops) {
    ...
    // switch.
    static List<List<double[]>> roundBorderCorners(List<List<double[]>> loops) {
