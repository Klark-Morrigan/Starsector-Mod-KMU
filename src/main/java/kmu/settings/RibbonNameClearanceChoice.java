 ...
 * so the band pass reads the mode without matching raw strings. Its labels are the Radio row's
 * options, spelt identically - see {@link LabeledChoice} for why they never change.
 */
