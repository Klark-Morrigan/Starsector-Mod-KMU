...
/**
 * What the political map lights up in answer to a hover, in two tiers: the cursor's halo and wash
 * on the one cell under the pointer, and the preview's wash on a whole set of cells at once. The
 * layer's own two switches sit with them, the bottom tier of the hover switching that starts on the
 * map-wide tab.
 *
