 ...
 * to one, so the render layer resolves a side without matching raw strings. Its labels are the
 * Radio row's options, spelt identically - see {@link LabeledChoice} for why they never change.
 */
