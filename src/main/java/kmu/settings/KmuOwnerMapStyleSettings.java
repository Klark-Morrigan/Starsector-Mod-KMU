...
/**
 * How each kind of owner-map cell paints: the fill, the two borders and the name of a faction-held
 ...
 *
 * <p>The decivilised kind carries one knob that is not paint: whether such a system counts
 * as inhabited at all. It is here because it is read against the shades below it - a player reaching
 ...
 * blanks the kind on every view at once, this bundle serving them all, and leaves the picker,
 * the ribbon and the stats counting what nothing on screen draws.
 */
public final class KmuOwnerMapStyleSettings {
    ...
    private KmuOwnerMapStyleSettings() {
    }
     ...
     *         paints that system's cell, offers its owner in the bloc picker, bands it in the
     ...
     */
    public static boolean shouldCountDecivilisedSystemsAsPopulated() {
     ...
     *         Mute toggle is off
     */
    public static double getOwnerMapMutedOpacityModifier() {
        return KmuLunaSettings.readDouble(
     ...
     */
    public static double getOwnerMapDesaturationDarkening() {
        return KmuLunaSettings.readDouble(
     ...
     */
    public static double getOwnerMapPresenceLightening() {
        return KmuLunaSettings.readDouble(
