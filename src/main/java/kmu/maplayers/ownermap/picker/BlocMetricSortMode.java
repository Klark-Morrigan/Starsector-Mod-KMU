...
/**
 * One owner-map sort mode: a bloc ranking read off a number the metrics already carry, or off the
 ...
 */
public final class BlocMetricSortMode<S extends BlocMetrics>
