...
/**
 * The owner map's inhabitation read: which star systems somebody lives in, off a rebuild's own
 ...
 *
 * <p>It sits in this tier rather than beside the framework's own visibility because these
 ...
 */
public final class OwnerMapInhabitation {

    // Reads only; never instantiated.
    private OwnerMapInhabitation() {
    }
