 ...
 * is the order, so a band cannot mean one thing under one painting mechanic and another under
 * the next.
 *
 ...
 *
 * @param blocId      the bloc this stake belongs to: a faction ID, or a group's bloc ID where
 *                    the view folds several factions into one bloc
...
public record BlocPresence(
     ...
     * gone from the sector is one the map cannot name - the same answer the holder resolve gives
     * a system whose colour faction has gone.
     *
