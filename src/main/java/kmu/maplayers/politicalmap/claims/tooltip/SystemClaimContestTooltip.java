...
public abstract class SystemClaimContestTooltip extends PoliticalMapCellTooltip {
    ...
    public SystemClaimContestTooltip(
    ...
    @Override
    public final boolean isStatingCoreClaimInBody() {
     ...
     */
    public static ColonyVisibility readColonyVisibility() {
     ...
     *                      an account tells an unowned collapse from an unowned derelict, and where
     *                      it learns how old its news of either is
