 ...
 *
 * <p>Plain data with no Starsector types, so a rule taking these stays free of the live economy:
 * what bars a bloc and what a bloc is made of arrive as functions over IDs, and where either comes
