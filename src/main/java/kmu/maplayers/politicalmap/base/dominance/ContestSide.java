...
public enum ContestSide {
    ...
    /** The blocs the alliance set folds into the holder's own - empty wherever nothing groups
     *  factions, and wherever nobody holds the system. */
    ALLIED(true),

    /** The blocs the alliance set leaves standing against the holder - everyone the other side did
     *  not take. */
    RIVAL(false);
     ...
     *
     * @param isStandingWithHolder whether the alliance set folds the contestant into the holder's
     *                             bloc
