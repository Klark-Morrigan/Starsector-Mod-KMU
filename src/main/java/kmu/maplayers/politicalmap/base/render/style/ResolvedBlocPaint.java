 ...
 * national border and the interior seam differ only in which element of the bundle they name, so
 * naming that element is the whole of what a caller has left to say.
 *
 * <p>Where {@link BlocStyling} answers which bundle a bloc draws from, this is that answer carried
