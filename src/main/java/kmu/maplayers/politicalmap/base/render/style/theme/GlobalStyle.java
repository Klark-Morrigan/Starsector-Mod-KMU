 ...
 * {@link BorderSmoothingStyle}, the {@link HoverHighlightStyle} the cursor's answer draws in,
 * and {@code desaturationDarkening}, how far a receded bloc's uniform Independent-based grey
 * is sunk toward black. Holding these once (rather than reading each ad hoc where it is used)
