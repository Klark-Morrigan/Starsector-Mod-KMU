...
holding under a narrow rule leaves settled systems holderless: on the claims view, a system settled
solely by a pirate haven, by the player or by the Remnant reaches the classifier with no claimant,
for reasons [`politics.holders`](../../politics/holders/README.md) sets out. Those cells are
settled, so they take this bundle. The
