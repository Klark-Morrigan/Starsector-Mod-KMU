 ...
 * down - a claim's siblings and military bonus, a weight's stability and patrols. Shared rather than
 * spelled per account because it is the same line: two accounts each composing their own would be
 * free to drift in what a term looks like, and a reader comparing one box against the next has no way
 * to tell a difference that means something from one that does not.
 *
...
final class TermTooltipLine {
     ...
     */
    static CellTooltipEntry buildTermEntry(String labelText, String valueText) {
     ...
     */
    static CellTooltipEntryLine buildTermLine(String labelText, String valueText) {
