 ...
 * has gone (the laying-out, in {@code kmu.maplayers.base.tooltip.layout}).
 *
 ...
 * stands a further step under the box's own voice (the level a walk lays it at). Stated by whoever
