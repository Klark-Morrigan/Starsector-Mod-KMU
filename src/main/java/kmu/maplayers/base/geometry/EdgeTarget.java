 ...
 * or more of the same cell ({@link #SAME_OWNER}), which is a cut interior to one
 * owner's own cells with no star on the far side at all. Naming the three keeps the far side
...
public sealed interface EdgeTarget {
    ...
    /**
     * More of the same owner's cells: a cut through them, made where a cell
     * was assembled from more than one piece. The two sides are the same owner,
