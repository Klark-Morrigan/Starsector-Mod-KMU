 ...
 * interior seam fused with a same-grouping neighbour.
 *
 ...
 * was pulled inward to the padded channel (a border against a different grouping,
 * ungrouped space, or the map frontier) and false when it was left on the true cell
 * edge to fuse with a same-grouping neighbour. The render layer fills the polygon and
