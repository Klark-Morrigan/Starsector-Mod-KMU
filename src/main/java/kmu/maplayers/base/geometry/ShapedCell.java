 ...
 * was pulled
 * inward to the padded channel (a border against a different faction, unowned
 * space, or the map frontier) and false when it was left on the true cell edge to
 * fuse with a same-faction neighbour. The render layer fills the polygon and
 * strokes its boundary edges as the bold national border and its remaining edges
 * as the faint interior province lines.
 */
