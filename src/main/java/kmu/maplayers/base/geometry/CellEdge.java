 ...
 * cell's outer reach bound, or more of the same ground. The edge classifier reads
 * this cell's grouping key against whatever the target names to decide whether the edge
 * is an interior seam (same grouping both sides, or no far side to differ from) or a
 * cluster boundary.
 */
