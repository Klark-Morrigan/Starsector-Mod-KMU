 ...
 * {@link MapLayerSidebarInput}, since a render pass gets no input events and cannot
 * consume them.
 *
...
public final class MapLayerSidebar implements CampaignUIRenderingListener {
    ...
    private static void drawTabFills(SidebarPlacement placement, MapLayer activeLayer,
    ...
    private static void drawTabDividersAndBaseline(SidebarPlacement placement, Color accent,
        ...
        for (var tab : placement.tabs()) {
            if (MapLayerRegistry.isActive(tab.layer())) {
                var bounds = tab.bounds();
    ...
    private static void drawTabLabels(SidebarPlacement placement, MapLayer activeLayer,
    ...
    private static void drawCaption(Rectangle caption, MapLayer activeLayer,
            float opacity) {
    ...
    private static String composeTabText(MapLayer layer) {
