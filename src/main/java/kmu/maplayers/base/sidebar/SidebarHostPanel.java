 ...
 * looks, the transient scroll and fold it is standing at, which layer it is showing, and which frame
 ...
 * scroll and fold, separate active-layer pick, and separate looks, over one layout.
 *
 ...
 * @param selection     the screen's own active-layer pick, read for the lit tab and body and written
