 ...
 *
 * <p>Held per installation rather than per layer, because standing is a fact about a layer
 ...
 * installation owns the lifetime without naming what it holds.
 *
 * <p>Disposal forgets rather than stands anything down. What an installation is disposed for is a
 ...
 * the campaign thread while a frame resolves the same installation on the render thread.
 */
