 ...
 *
 * <p>The framework runs the frame and never decides this. Each answer is one layer's own switch
 * ANDed with the switches above it that answer for every layer ({@link MapHoverGates}), and the
 * switches a layer offers are its own business - one painting hazards has no reason to spell them
 * the way one painting holdings does.
 *
 ...
 */
public interface MapLayerHoverGates {
