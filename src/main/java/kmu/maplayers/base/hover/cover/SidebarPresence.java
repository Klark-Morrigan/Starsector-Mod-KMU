 ...
 * directly would work only inside the game itself - which is where a containment rule is
 * hardest to see failing.
 *
 * <p>A point rather than the roster behind it, so a caller states the answer it is about without
