 ...
 *
 * <p>Two questions are put to the kind, and neither is derivable from the other. {@link
 ...
 * on somebody else's word in place of the player having found them.
 *
...
public enum ColonyKind {
     ...
     *
     * <p>True for the collapsed colony alone. The others are entities the player has either found
     * or not, and the fog answers for them from the entity flag. A decivilised world sits on a
     * planet, which is always discovered, so nothing about it is withheld except vanilla's survey
