...
*grouping key*, and the two things a name needs beyond geometry - what it reads and what shade it
...
The search takes each cluster's name measurement and colour as functions of its grouping key, keyed
