...
final class CellHitTestTest {
    ...
    class ResolveSystemKeyAt {
        ...
        void aPointInsideACellResolvesToItsSystem() {
            ...
            assertThat(CellHitTest.resolveSystemKeyAt(5, 5, cells))
        ...
        void eachCellClaimsOnlyItsOwnAreaWhenSeveralArePresent() {
            ...
            assertThat(CellHitTest.resolveSystemKeyAt(25, 5, cells))
                .isEqualTo(buildCellKey("B"));
        }
        ...
        void aPointInTheGapBetweenCellsResolvesToNothing() {
            ...
            assertThat(CellHitTest.resolveSystemKeyAt(15, 5, cells))
                .isNull();
        }
        ...
        void aPointBeyondEveryCellResolvesToNothing() {
            ...
            assertThat(CellHitTest.resolveSystemKeyAt(100, 100, cells))
                .isNull();
        }
        ...
        void aPointOnASharedEdgeResolvesTheSameWayEveryCall() {
            ...
            assertThat(first)
                .isEqualTo(CellHitTest.resolveSystemKeyAt(10, 5, cells));
            assertThat(first)
                .isIn(buildCellKey("A"), buildCellKey("B"));
        }

        @Test
        void anEmptyMapResolvesToNothing() {

            assertThat(CellHitTest.resolveSystemKeyAt(5, 5, Map.of()))
                .isNull();
        }
        ...
        void aCellWithNoDrawablePolygonCanNeverBeHit() {
            ...
            assertThat(CellHitTest.resolveSystemKeyAt(0, 0, cells))
                .isNull();
        }
    }
}
