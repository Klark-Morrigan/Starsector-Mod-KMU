 ...
 * persists that scope's frozen key and bumps the filter revision so the reading layer repaints, a
 * clear drops the key and bumps too, every mutation no-ops cleanly before the sector exists, the
