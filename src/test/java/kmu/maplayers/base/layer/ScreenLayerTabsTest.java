 ...
 *
 * <p>Its two writes are pinned as one frame's work. What keeps that from cutting the map away is
 * {@link ScreenDrawnLayerTest}'s subject, not this one's: the screen goes on drawing what was on it, so
 * nothing here has a dissolve to wait for.
 *
...
final class ScreenLayerTabsTest {
    ...
    class HealPickOntoOfferedTabs {
        ...
        void healPickOntoOfferedTabsWritesBothHalvesOnTheOneFrame() {
            ...
            // and a row moved again meanwhile would strand the half still owed.
            registerTheEmptyViewBesideALayerThatPaints();
