 ...
 * and that a publish is what the next read sees.
 *
 ...
 *
 * <p>Every case builds a holder of its own, so a published hover cannot reach another case. Which
 * sector's holder a caller gets is the index's question and is pinned there.
 */
