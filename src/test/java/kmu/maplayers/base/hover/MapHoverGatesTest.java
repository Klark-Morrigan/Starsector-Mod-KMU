    ...
    class IsHoverEffectsEnabled {
        ...
        void isHoverEffectsEnabledIsTrueWithBothTiersOn() {
            try (MockedStatic<KmuLunaSettings> settingsMock = mockStatic(KmuLunaSettings.class)) {
                ...
                settingsMock.when(KmuLunaSettings::getMapHoverEffectsEnabled).thenReturn(true);
        ...
        void isHoverEffectsEnabledIsFalseWithTheHoveringMasterOff() {
            ...
            try (MockedStatic<KmuLunaSettings> settingsMock = mockStatic(KmuLunaSettings.class)) {
                settingsMock.when(KmuLunaSettings::getMapHoveringEnabled).thenReturn(false);
                settingsMock.when(KmuLunaSettings::getMapHoverEffectsEnabled).thenReturn(true);
        ...
        void isHoverEffectsEnabledIsFalseWithTheGlobalEffectsSwitchOff() {
            try (MockedStatic<KmuLunaSettings> settingsMock = mockStatic(KmuLunaSettings.class)) {
                settingsMock.when(KmuLunaSettings::getMapHoveringEnabled).thenReturn(true);
                settingsMock.when(KmuLunaSettings::getMapHoverEffectsEnabled).thenReturn(false);
        ...
        void isHoverEffectsEnabledIsUntouchedByTheGlobalTooltipSwitch() {
            ...
            try (MockedStatic<KmuLunaSettings> settingsMock = mockStatic(KmuLunaSettings.class)) {
                settingsMock.when(KmuLunaSettings::getMapHoveringEnabled).thenReturn(true);
                settingsMock.when(KmuLunaSettings::getMapHoverEffectsEnabled).thenReturn(true);
                settingsMock.when(KmuLunaSettings::getMapHoverTooltipEnabled).thenReturn(false);
