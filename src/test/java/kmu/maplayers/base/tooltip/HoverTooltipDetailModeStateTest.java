 ...
 * is a toggle and not a one-way switch), and that the shared instance is genuinely one instance -
 * two collaborators resolving different holders would leave the box ignoring the key.
 *
...
final class HoverTooltipDetailModeStateTest {
    ...
    class ToggleMode {
        ...
        @Test
        void toggleModeIsItsOwnInverseOverAnyEvenCount() {
