...
final class ArrangementBoxLayoutTest {
    ...
    class ResolveControlsCellLeft {
        ...
        void resolveControlsCellLeftStandsTheControlsAChannelBeyondTheLabelColumn() {
            ...
            assertThat(ArrangementBoxLayout.resolveControlsCellLeft())
                .isEqualTo(220f);
        }

        @Test
        void resolveControlsCellLeftLeavesTheControlsEndingAPadInFromTheBoxEdge() {
            // What 3B-7 will measure the other edge against: the controls run from here to the sum of
            // their parts, and the box is as wide as that plus a pad at either side.
            var controlsRightEdge =
                ArrangementBoxLayout.resolveControlsCellLeft() + ArrangementBoxLayout.CONTROLS_WIDTH;
    ...
    class ResolveFooterLeft {
        ...
        void resolveFooterLeftStandsTheWayOutAPadInFromTheBoxsRightEdge() {
            ...
            var footerRightEdge =
                ArrangementBoxLayout.resolveFooterLeft() + ArrangementBoxLayout.APPLY_BUTTON_WIDTH;
