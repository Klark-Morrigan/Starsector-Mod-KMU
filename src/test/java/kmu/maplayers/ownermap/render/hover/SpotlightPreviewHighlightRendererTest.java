 ...
 */
final class SpotlightPreviewHighlightRendererTest {

    // The layer whose picker is previewed, which names the memo the presence is read off.
    ...
    class ResolvePreviewPaint {
        ...
        void resolvePreviewPaintLightsNothingForAHoverReportedUnderAnotherViewsScope() {
            ...
            FilterHoverSlot
                ...
                .recordHoveredId(createScopeOfView("other-view"), BLOC_ID);
    ...
    private static OwnerMapClusters buildFrameDrawing(
        ...
        for (var cellId : drawnCellIds) {
            clusters.getPaintedCells().putPaintedCell(
                buildCellKey(cellId),
                OwnerMapClusterFixtures.createPlaceholderPaintedCellOn(buildSquare()));
        }
        return clusters;
    }
    ...
    private OwnerPaintedView stubViewFinding(BlocPresenceIndex presenceIndex) {
