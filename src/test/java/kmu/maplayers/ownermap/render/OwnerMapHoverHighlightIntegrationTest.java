...
/**
 * Pins the one guarantee no unit test on either side of it can make: what a hover lights up over an
 ...
 */
final class OwnerMapHoverHighlightIntegrationTest {
    ...
    private static HoverHighlight buildAndHoverUnpopulatedCellUnder(
        ...
        var clusters = buildUnpopulatedClustersUnder(cornerRounding);
        ...
        clusters.getPaintedCells().putPaintedCell(UNPOPULATED_CELL, painted);
    ...
    private static OwnerMapClusters buildUnpopulatedClustersUnder(
            CornerRoundingStyle cornerRounding) {
    ...
    // is expected to remove. Every edge is cluster border, which is what a lone cell's are.
