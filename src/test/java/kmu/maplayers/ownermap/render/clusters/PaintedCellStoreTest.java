...
import kmu.maplayers.ownermap.render.ribbon.RibbonBand;
import kmu.maplayers.ownermap.render.ribbon.RibbonPathVerdict;
...
final class PaintedCellStoreTest {
    ...
    private static PaintedCell buildPaintedCellOn(List<double[]> paintedExtent) {
        return OwnerMapClusterFixtures.createPlaceholderPaintedCellOn(paintedExtent);
    }
