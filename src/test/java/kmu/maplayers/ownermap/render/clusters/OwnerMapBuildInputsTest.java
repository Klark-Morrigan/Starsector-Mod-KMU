 ...
 *
 * <p>The cascade's rule is {@link kmu.maplayers.ownermap.render.style.OwnerStylingTest}'s
 * and what an element then paints is
 * {@link kmu.maplayers.ownermap.render.style.ResolvedBlocPaintTest}'s; what belongs here
 ...
 */
final class OwnerMapBuildInputsTest {
    ...
    private static final SystemOwner HOLDER =
        new SystemOwner(BLOC_ID, Color.RED, Color.BLUE);
    ...
    class ResolveBlocPaintOf {
        ...
        private static OwnerPaintedView buildViewAdjustingBy(ElementStyleAdjustment adjustment) {
