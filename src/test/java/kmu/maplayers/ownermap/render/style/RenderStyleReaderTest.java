    ...
    class ReadFactionStyle {
        ...
        void readFactionStyleThreadsEachFactionSettingIntoItsMatchingSlot() {
            ...
            try (var styleSettingsMock = mockStatic(KmuOwnerMapStyleSettings.class)) {
                ...
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getFactionFillColour)
                    .thenReturn(FactionPaletteChoice.PRIMARY);
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getFactionFillOpacity)
                ...
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getFactionOuterBorderOpacity)
                    .thenReturn(OUTER_OPACITY);
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getFactionOuterBorderWidth)
                    .thenReturn(OUTER_WIDTH);
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getFactionInnerBorderColour)
                    .thenReturn(FactionPaletteChoice.NONE);
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getFactionInnerBorderOpacity)
                    .thenReturn(INNER_OPACITY);
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getFactionInnerBorderWidth)
    ...
    class ReadIndependentStyle {
        ...
        void readIndependentStyleThreadsEachIndependentSettingIntoItsMatchingSlot() {
            ...
            try (var styleSettingsMock = mockStatic(KmuOwnerMapStyleSettings.class)) {
                ...
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getIndependentFillColour)
                    .thenReturn(FactionPaletteChoice.SECONDARY);
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getIndependentFillOpacity)
                    .thenReturn(FILL_OPACITY);
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getIndependentOuterBorderColour)
                    .thenReturn(FactionPaletteChoice.PRIMARY);
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getIndependentOuterBorderOpacity)
                    .thenReturn(OUTER_OPACITY);
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getIndependentOuterBorderWidth)
                    .thenReturn(OUTER_WIDTH);
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getIndependentInnerBorderColour)
                    .thenReturn(FactionPaletteChoice.NONE);
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getIndependentInnerBorderOpacity)
                    .thenReturn(INNER_OPACITY);
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getIndependentInnerBorderWidth)
                    .thenReturn(INNER_WIDTH);
    ...
    class ReadDecivilisedStyle {
        ...
        void readDecivilisedStyleDrawsTheFillAndOutlineInTheNeutralColour() {
            ...
            try (var styleSettingsMock = mockStatic(KmuOwnerMapStyleSettings.class)) {
                ...
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getDecivilisedFillOpacity)
                    .thenReturn(NEUTRAL_FILL_OPACITY);
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getDecivilisedBorderOpacity)
                    .thenReturn(NEUTRAL_OPACITY);
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getDecivilisedBorderWidth)
    ...
    class ReadUninhabitedStyle {
        ...
        void readUninhabitedStyleDrawsTheOutlineInTheNeutralColourWhenTheSidebarToggleIsOn() {
            ...
            try (var styleSettingsMock = mockStatic(KmuOwnerMapStyleSettings.class)) {
                ...
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getUninhabitedBorderOpacity)
                    .thenReturn(NEUTRAL_OPACITY);
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getUninhabitedBorderWidth)
                    .thenReturn(NEUTRAL_WIDTH);
        ...
        void readGlobalStyleGathersEverySectorWideKnobIntoOneTier() {
            ...
            try (var geometrySettingsMock = mockStatic(KmuOwnerMapGeometrySettings.class);
                ...
                highlightSettingsMock
                    .when(KmuOwnerMapHighlightSettings::getOwnerMapHoverGlowOpacity)
                    .thenReturn(HOVER_GLOW_OPACITY);
                highlightSettingsMock
                    .when(KmuOwnerMapHighlightSettings::getOwnerMapPreviewWashOpacity)
                    .thenReturn(PREVIEW_WASH_OPACITY);

                geometrySettingsMock
                    .when(KmuOwnerMapGeometrySettings::getOwnerMapHatchSpacing)
                    .thenReturn(HATCH_SPACING);
                geometrySettingsMock
                    .when(KmuOwnerMapGeometrySettings::getOwnerMapHatchAngleRadians)
                    .thenReturn(HATCH_ANGLE);
                geometrySettingsMock
                    .when(KmuOwnerMapGeometrySettings::getOwnerMapHatchWidthFraction)
                    .thenReturn(HATCH_WIDTH_FRACTION);
                geometrySettingsMock
                    .when(KmuOwnerMapGeometrySettings::getOwnerMapHatchJoinToleranceFraction)
                    .thenReturn(HATCH_JOIN_TOLERANCE);
                geometrySettingsMock
                    .when(KmuOwnerMapGeometrySettings::shouldSmoothHatchLines)
                    .thenReturn(false);
                geometrySettingsMock
                    .when(KmuOwnerMapGeometrySettings::shouldSandBorderSpikes)
                    .thenReturn(true);
                geometrySettingsMock
                    .when(KmuOwnerMapGeometrySettings::shouldRoundBorderCorners)
                    .thenReturn(false);
                geometrySettingsMock
                    .when(KmuOwnerMapGeometrySettings::getOwnerMapBorderCornerRadius)
                    .thenReturn(CORNER_RADIUS);
                geometrySettingsMock
                    .when(KmuOwnerMapGeometrySettings::getOwnerMapBorderCornerSegments)
                    .thenReturn(CORNER_SEGMENTS);
                geometrySettingsMock
                    .when(KmuOwnerMapGeometrySettings::getOwnerMapBorderChamferAngleRadians)
                ...
                styleSettingsMock
                    .when(KmuOwnerMapStyleSettings::getOwnerMapPresenceLightening)
        ...
        void readBorderSmoothingStyleLandsEachKnobInTheSubRecordOfThePassThatReadsIt() {
            ...
            try (var geometrySettingsMock = mockStatic(KmuOwnerMapGeometrySettings.class)) {
                ...
                geometrySettingsMock
                    ...
                    .thenReturn(false);
                geometrySettingsMock
                    .when(KmuOwnerMapGeometrySettings::getOwnerMapBorderSpikeHeight)
                    .thenReturn(SPIKE_HEIGHT);
                geometrySettingsMock
                    .when(KmuOwnerMapGeometrySettings::getOwnerMapBorderSpikeAngleRadians)
                ...
                // knob is handed. The split is where a field could be threaded into the wrong
    ...
    class ReadHoverHighlightStyle {
        ...
        void readHoverHighlightStyleThreadsEachHoverSettingIntoItsMatchingSlot() {
            ...
            try (var highlightSettingsMock = mockStatic(KmuOwnerMapHighlightSettings.class)) {
                ...
                highlightSettingsMock
                    .when(KmuOwnerMapHighlightSettings::getOwnerMapHoverHighlightColour)
                    .thenReturn(FactionPaletteChoice.SECONDARY);
                highlightSettingsMock
                    .when(KmuOwnerMapHighlightSettings::getOwnerMapHoverGlowOpacity)
                    .thenReturn(GLOW_OPACITY);
                highlightSettingsMock
                    .when(KmuOwnerMapHighlightSettings::getOwnerMapHoverGlowWidth)
                    .thenReturn(GLOW_WIDTH);
                highlightSettingsMock
                    .when(KmuOwnerMapHighlightSettings::getOwnerMapHoverGlowLayers)
                    .thenReturn(GLOW_LAYERS);
                highlightSettingsMock
                    .when(KmuOwnerMapHighlightSettings::getOwnerMapHoverGlowPulseStrength)
                    .thenReturn(GLOW_PULSE_STRENGTH);
                highlightSettingsMock
                    .when(KmuOwnerMapHighlightSettings::getOwnerMapHoverGlowPulsePeriod)
                    .thenReturn(GLOW_PULSE_PERIOD);
                highlightSettingsMock
                    .when(KmuOwnerMapHighlightSettings::getOwnerMapHoverWashOpacity)
                    .thenReturn(WASH_OPACITY);
                highlightSettingsMock
                    .when(KmuOwnerMapHighlightSettings::getOwnerMapHoverWashOutlineOpacity)
                    .thenReturn(WASH_OUTLINE_OPACITY);
                highlightSettingsMock
                    .when(KmuOwnerMapHighlightSettings::getOwnerMapHoverWashOutlineWidth)
    ...
    class ReadPreviewHighlightStyle {
        ...
        void readPreviewHighlightStyleThreadsEachPreviewSettingIntoItsMatchingSlot() {
            ...
            try (var highlightSettingsMock = mockStatic(KmuOwnerMapHighlightSettings.class)) {
                ...
                highlightSettingsMock
                    .when(KmuOwnerMapHighlightSettings::getOwnerMapPreviewHighlightColour)
                    .thenReturn(FactionPaletteChoice.PRIMARY);
                highlightSettingsMock
                    .when(KmuOwnerMapHighlightSettings::getOwnerMapPreviewWashOpacity)
                    .thenReturn(WASH_OPACITY);
