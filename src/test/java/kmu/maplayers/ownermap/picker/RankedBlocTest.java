...
final class RankedBlocTest {
    ...
    private static final BlocMetricsFake ANY_STATS_FAKE = new BlocMetricsFake(5, 8, 40, 12);
    ...
    private static final RankedBloc<BlocMetricsFake> HEGEMONY = new RankedBloc<>(
    ...
    class IsDimmed {
        ...
        void isDimmedIsAnsweredByTheMetricsRatherThanTheIdentity() {
            ...
            // states none would pass whether the delegation ran or not.
            var paintingNothing = new RankedBloc<>(
                new SelectableBloc("hegemony", "Hegemony", "crest_heg"),
                new BlocMetricsFake(0, 3, 3, 40));

            assertThat(paintingNothing.isDimmed())
                .isTrue();
        }
        ...
        void isDimmedFollowsThePayloadBackToFullStrength() {
            ...
            var painting = new RankedBloc<>(
                new SelectableBloc("hegemony", "Hegemony", "crest_heg"),
                new BlocMetricsFake(2, 3, 3, 40));

            assertThat(painting.isDimmed())
                .isFalse();
        }
