 ...
 * the sector currently produces. The words a rule here suppresses are pinned apart from the ones
 * that simply stand together.
 *
 ...
 */
public final class ColonyQualifierTest {

    // A finding a layer leads with, already worded - one no vocabulary word here spells, so reading
    // it back is reading the layer's word rather than one of this resolver's.
    private static final String LEADING_FINDING = "stronghold";
    ...
    class QualifyColony {
        ...
        void qualifyColonyStatesTheLayersLeadingFindingAheadOfEverythingElse() {
            ...
            assertThat(qualify("Chicomoztoc", new ColonyQualifierFacts(
                    ...
                    new ColonyConcealment(IS_UNDISCOVERED, IS_OPEN, IS_A_SECRET),
                    IS_LISTED)))
                .isEqualTo("stronghold, undiscovered");
        }
