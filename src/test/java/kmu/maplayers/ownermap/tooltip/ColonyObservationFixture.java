 ...
 */
public final class ColonyObservationFixture {

    /** When the observation was made, as the register stamps it. */
    public static final long OBSERVED_AT = 4_200L;

    /** The date the clock reports for that moment, as a remark names it. */
    public static final String OBSERVED_DATE = "c206.05.12";
     ...
     */
    public static CampaignClockAPI installObservedClock(SectorAPI sectorMock) {
