 ...
 * name travel inside the line's own words so the two centre together, and a faction the sector does not
 * know still speaks as its bare ID rather than as a blank.
 */
