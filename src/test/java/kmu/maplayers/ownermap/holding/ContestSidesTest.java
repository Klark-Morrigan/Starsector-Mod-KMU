...
class ContestSidesTest {
    ...
    class SelectSide {
        ...
        void selectSideKeepsTheOrderTheContestantsArrivedIn() {
            ...
            assertThat(new ContestSides(
                    HOLDER,
                    new BlocAffiliation(
                        HolderGroupingFixture.buildGroupOf(HOLDER, secondAlly, ALLY)))
        ...
        void selectSideKeepsTwoBlocsAlliedWithEachOtherButNotWithTheHolderAsRivals() {
            ...
            assertThat(new ContestSides(
                    HOLDER,
                    new BlocAffiliation(HolderGroupingFixture.buildGroupOf(RIVAL, OUTSIDER)))
    ...
    private static ContestSides buildSidesUnderAGroup() {
        return new ContestSides(HOLDER, buildGroupAffiliation());
    }

    private static BlocAffiliation buildGroupAffiliation() {
        return new BlocAffiliation(HolderGroupingFixture.buildGroupOf(HOLDER, ALLY));
    }
}
