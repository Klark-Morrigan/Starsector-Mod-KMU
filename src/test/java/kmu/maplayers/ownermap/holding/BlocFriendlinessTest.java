...
class BlocFriendlinessTest {
    ...
    class AreBlocsFriendly {
        ...
        void readsOneFactionAgainstOneAsThatSinglePair() {
            ...
            // pinned to the identity grouping and every install with nothing grouping factions.
        ...
        void isFalseWhereEitherBlocIsMadeOfNobody() {
            // Friendliness is a positive statement, and walking no pairs at all would report the vacuous
