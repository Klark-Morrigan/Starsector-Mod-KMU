...
import static kmu.maplayers.politicalmap.tooltip.PoliticalMapBoxReads.buildClaimBreakdownReaderOver;
import static kmu.maplayers.politicalmap.tooltip.PoliticalMapBoxReads.buildDominanceBox;
...
final class DerelictReadoutIntegrationTest {
    ...
    class ReadBreakdown {
        ...
        void resolvesTheSameClaimantAndScoresWhetherOrNotADerelictStandsThere() {
            ...
            var withoutDerelict = readClaimBreakdown(
                SectorOwnershipFixtures.buildSectorWith(SYSTEM_ID, buildColony()));
    ...
    private static SectorAPI buildSectorHoldingADerelict(MarketAPI... listedColonies) {
        ...
        var sector = SectorOwnershipFixtures.buildSectorWith(SYSTEM_ID, listedColonies);
