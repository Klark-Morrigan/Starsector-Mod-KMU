...
public final class ContentInputsFixtures {
    ...
    /**
     * A reading carrying the alliances view's non-allied recede, for the suites about which blocs a
     * view hands that recede to.
     *
     * @param allianceRecede how a bloc outside an alliance draws
     * @return that pick over the inert reading
     */
    public static ContentInputs createInputsRecedingNonAllied(
            ElementStyleAdjustment allianceRecede) {
