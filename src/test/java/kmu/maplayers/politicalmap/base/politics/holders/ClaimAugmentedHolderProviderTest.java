...
final class ClaimAugmentedHolderProviderTest {
    ...
    class ResolveHolder {
        ...
        void resolveHolderFoldsClaimedUnheldSystemsInAsUnfilledOffFilter() {
            ...
            when(baseProviderMock.resolveHolder(sectorMock, grouping, null)).thenReturn(
            ...
            try (var sectorClaimsMock = mockStatic(SectorClaims.class)) {
                ...
                assertThat(resolution.ownerBySystemId()).containsOnly(
                        Map.entry("held", heldHolder), Map.entry("claimed", claimedHolder));
        ...
        void resolveHolderRekeysTheSpotlitBlocsOwnClaimOntoItsSpotlightHolderUnderFilter() {
            ...
            when(baseProviderMock.resolveHolder(sectorMock, grouping, "hegemony")).thenReturn(
                    new HolderResolution(
                            Map.of("held", spotlightHolder), Set.of("held"), Set.of()));
            var provider = new ClaimAugmentedHolderProvider(baseProviderMock, claimReaderMock);
            try (var sectorClaimsMock = mockStatic(SectorClaims.class);
                ...
                assertThat(resolution.ownerBySystemId().get("claimed")).isSameAs(spotlightHolder);
                assertThat(resolution.unfilledSystemIds()).containsExactly("claimed");
