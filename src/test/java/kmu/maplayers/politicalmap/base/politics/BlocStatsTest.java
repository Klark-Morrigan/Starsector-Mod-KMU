...
final class BlocStatsTest {
    ...
    class AddSystem {
        ...
        void addSystemAddsPresenceScoreAndSizeButNotDominationForANonWinner() {
            ...
            assertThat(BlocStats.EMPTY.addSystem(false, 5000, 5))
                    .isEqualTo(new BlocStats(0, 1, 5000, 5));
        }
        ...
        void addSystemCountsDominationWhenTheBlocWinsTheSystem() {
            ...
            assertThat(BlocStats.EMPTY.addSystem(true, 5000, 5))
                    .isEqualTo(new BlocStats(1, 1, 5000, 5));
        }
        ...
        void addSystemAccumulatesAcrossSuccessiveSystems() {
            ...
            assertThat(BlocStats.EMPTY.addSystem(true, 5000, 5).addSystem(false, 3000, 3))
                    .isEqualTo(new BlocStats(1, 2, 8000, 8));
        }
    }
}
