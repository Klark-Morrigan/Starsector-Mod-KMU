 ...
 * five stubs in each test, both point here, so the mode-to-label wiring the tests assume lives in one
 * place. No test methods, so it adds nothing the nested-tests gate must account for.
 */
