...
import static kmu.maplayers.ownermap.owners.SectorOwnershipFixtures.HALF_STABILITY;
import static kmu.maplayers.ownermap.owners.SectorOwnershipFixtures.NO_STABILITY;
...
import static kmu.maplayers.ownermap.owners.SectorOwnershipFixtures.buildHiddenMarketAtStability;
import static kmu.maplayers.ownermap.owners.SectorOwnershipFixtures.buildMarketAtStability;
...
import static kmu.maplayers.ownermap.owners.SectorOwnershipFixtures.placeMarketsOnOneEntity;
import static kmu.maplayers.ownermap.owners.SectorOwnershipFixtures.placeMarketsOnSystemEntities;
import static kmu.maplayers.politicalmap.dominance.weighting.MarketWeights.DOMINANCE_WEIGHT_SCALE;
...
class KnownMarketFootprintsIntegrationTest {
    ...
    private static Colonies readColoniesIn(SectorAPI sector) {
    ...
    class ReadUnweighedColoniesByFaction {
        ...
        void readUnweighedColoniesByFactionLeavesAFactionHoldingOnlyOneOutOfThePassEntirely() {
            ...
            // rather than off what was weighed.
            var sector = buildSectorWith(
                "galatia",
