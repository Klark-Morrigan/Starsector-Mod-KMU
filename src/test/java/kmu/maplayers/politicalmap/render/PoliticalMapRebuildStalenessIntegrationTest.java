...
import kmu.maplayers.ownermap.ContentInputsTest;
...
final class PoliticalMapRebuildStalenessIntegrationTest {
    ...
    private static final String REBUILD_DRAWABLES_ROW = "ownerMap.rebuildDrawables";
    ...
    private final UninhabitedOutlinePreference outlinePreferenceMock = mock(UninhabitedOutlinePreference.class);

    private SectorMapMachinery machinery;
    private OwnerMapCache cache;
    ...
    class Refresh {
        ...
        void refreshRebuildsOncePerSwitchBetweenPanelsSetDifferently() {
            ...
            when(outlinePreferenceMock.isOutlineDrawn(OTHER_SCREEN))
                .thenReturn(true);
    ...
    private void stageASettledSector() {
        ...
        var hegemony = SectorOwnershipFixtures.buildFaction(HEGEMONY_ID, Color.RED);

        SectorAPI sector = SectorOwnershipFixtures.buildSectorWithSystems(
            List.of(hegemony),
            listSystemMarkets(
                ALPHA_ID,
                SectorOwnershipFixtures.buildVisibleMarket(hegemony, COLONY_SIZE)),
