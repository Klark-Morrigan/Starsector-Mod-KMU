 ...
 *  - two same-faction cells fuse into one border ring (their shared seam dropped),
 *  - a cell facing a different faction keeps that shared edge as border,
...
final class SystemClusterBordersTest {
    ...
    // Two distinct factions, and the palette colours the border tracer never reads
    // but DominantOwner requires.
